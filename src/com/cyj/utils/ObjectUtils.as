...
//		{
//			var reg:RegExp = /((__AS3__\.vec::Vector\.<(.*?)>)|Array)/gi;
...
//			{
//				if(toObj.hasOwnProperty(prop) || describe.@isDynamic)
//				{
//					
//					var str:String= props[prop]?props[prop]:getQualifiedClassName(data[prop]);
//					reg.lastIndex = 0;
